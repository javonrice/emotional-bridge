...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "LOOP maps the emotional pattern behind compulsive behavior. Awareness is the mechanism." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "LOOP — See what's running you." },
      { name: "twitter:description", content: "LOOP maps the emotional pattern behind compulsive behavior. Awareness is the mechanism." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/c1f47419-1f07-46a3-b6c4-832bcd3a4448/id-preview-d5c066e4--f8b7ba6c-31a0-41e7-8eb7-4f51e2108e78.lovable.app-1779906008490.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/c1f47419-1f07-46a3-b6c4-832bcd3a4448/id-preview-d5c066e4--f8b7ba6c-31a0-41e7-8eb7-4f51e2108e78.lovable.app-1779906008490.png" },
